...
def make_population_with_kruscal_trees(distMatrix, Cmin: int, Cmax: int):
    edge_list = get_edge_list_from_dist_matrix(distMatrix)
...
def get_edge_list_from_dist_matrix(distMatrix: list[list[float]]) -> list[edge]:
    ret = []
